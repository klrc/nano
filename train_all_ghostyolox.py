...
if __name__ == "__main__":
    ...
    try:
        ...
        model = Ghostyolox_3x3_m96(num_classes=3)
        device = load_device("cuda")
        class_names = ["person", "bike", "car"]
        criteria = SimOTA(3, True)
    ...
    try:
        ...
        model = Ghostyolox_4x3_l64(num_classes=3)
        device = load_device("cuda")
        class_names = ["person", "bike", "car"]
        criteria = SimOTA(3, True)
    ...
    try:
        ...
        model = Ghostyolox_4x3_l128(num_classes=3)
        device = load_device("cuda")
        class_names = ["person", "bike", "car"]
        criteria = SimOTA(3, True)
    ...
    try:
        ...
        model = ESyolox_3x3_m96(num_classes=3)
        device = load_device("cuda")
        class_names = ["person", "bike", "car"]
        criteria = SimOTA(3, True)
