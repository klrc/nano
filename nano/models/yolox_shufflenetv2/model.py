    ...
    def __init__(self):
        ...
        self.block_2 = CSPBlock(
            ...
            nn.Sequential(
                ...
                residual_reversed_bottleneck(24, 48, 24),
            ),
        ...
        self.block_3 = CSPBlock(
            ...
            nn.Sequential(
                ...
                residual_reversed_bottleneck(32, 64, 32),
                residual_reversed_bottleneck(32, 64, 32),
                reversed_bottleneck(32, 64, 64),
                residual_reversed_bottleneck(64, 128, 64),
                residual_reversed_bottleneck(64, 128, 64),
                residual_reversed_bottleneck(64, 128, 64),
            ),
        ...
        self.block_4 = CSPBlock(
            ...
            nn.Sequential(
                ...
                residual_reversed_bottleneck(96, 192, 96),
                residual_reversed_bottleneck(96, 192, 96),
            ),
        ...
        self.block_5 = CSPBlock(
            ...
            nn.Sequential(
                ...
                residual_reversed_bottleneck(160, 320, 160),
                residual_reversed_bottleneck(160, 320, 160),
                reversed_bottleneck(160, 320, 320),
            ),
            convpack_1x1(608, 320),  # 288+ 320 = 608 -> 320
        )
...
class YoloCSPMobilenetV2(nn.Module):
    def __init__(self, num_classes):
        ...
        self.pan = PathAggregationPyramid([192, 288, 320], [128, 128, 128])
...
def yolox_cspm_depthwise(num_classes=3):
    return YoloCSPMobilenetV2(num_classes)


if __name__ == "__main__":
    # model = yolox_cspm_depthwise()
