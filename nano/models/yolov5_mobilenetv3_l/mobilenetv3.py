...
def _mobilenet_v3_conf(arch: str, width_mult: float = 1.0, reduced_tail: bool = False, dilated: bool = False,
    ...
    inverted_residual_setting = [
        ...
        bneck_conf(24, 5, 72, 40, False, "RE", 2, 1),  # C2
        bneck_conf(40, 5, 120, 40, False, "RE", 1, 1),
        bneck_conf(40, 5, 120, 40, False, "RE", 1, 1),
        bneck_conf(40, 3, 240, 80, False, "RE", 2, 1),  # C3
        bneck_conf(80, 3, 200, 80, False, "RE", 1, 1),
        bneck_conf(80, 3, 184, 80, False, "RE", 1, 1),
        bneck_conf(80, 3, 184, 80, False, "RE", 1, 1),
        bneck_conf(80, 3, 480, 112, False, "RE", 1, 1),
        bneck_conf(112, 3, 672, 112, False, "RE", 1, 1),
        bneck_conf(112, 5, 672, 160 // reduce_divider, False, "RE", 2, dilation),  # C4
        bneck_conf(160 // reduce_divider, 5, 960 // reduce_divider, 160 // reduce_divider, False, "RE", 1, dilation),
        bneck_conf(160 // reduce_divider, 5, 960 // reduce_divider, 160 // reduce_divider, False, "RE", 1, dilation),
    ]
...
def _mobilenet_v3_model(
    ...
    **kwargs: Any
    ...
    if pretrained:
        ...
        state_dict = {k: v for k, v in state_dict.items() if k in raw_state_dict}
