...
from ..detection.augmentations import Albumentations, augment_hsv, copy_paste, letterbox, mixup, random_perspective
from ..detection.general import (
    check_requirements,
    check_file,
    check_dataset,
    xywh2xyxy,
...
from .._utils.torch_utils import torch_distributed_zero_first
...
class LoadImagesAndLabels(Dataset):  # for training/testing
    ...
    def cache_labels(self, path=Path("./labels.cache"), prefix=""):
        ...
        with Pool(NUM_THREADS) as pool:
            pbar = tqdm(
                pool.imap_unordered(verify_image_label, zip(self.img_files, self.label_files, repeat(prefix))),
                desc=desc,
