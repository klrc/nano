...
from object_detection.yolov5_ultralytics import ultralytics_yolov5s, ultralytics_yolov5n
...
if __name__ == "__main__":
    ...
    settings.imgsz = 640
    settings.save_dir = 'runs/ultralytics_yolov5n'
    model = ultralytics_yolov5n(num_classes=80, weights='runs/ultralytics_yolov5n.0/best.pt')
    train(model, settings, device="0")
