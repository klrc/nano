...
target_size = [224, 416]
target_root = "../datasets/calib_dataset_416x"
...
with open(f"{target_root}/labels.txt", "w") as f:
    f.write("background\n")
    f.write("person\n")
    f.write("bike\n")
    f.write("car\n")
...
for img_file in tqdm(os.listdir(root + "/val2012")):
    ...
    img = cv2.copyMakeBorder(
        img, paddings[0], paddings[0], paddings[1], paddings[1], cv2.BORDER_CONSTANT, value=(114, 114, 114)
    )
