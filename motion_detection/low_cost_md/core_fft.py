...
class MotionDetection:
    ...
    def __call__(self, frame):
        ...
        # magnitude_spectrum = n
        return magnitude_spectrum.astype(np.uint8)
        # frame = np.fft.ifft2(fft_frame)
...
if __name__ == "__main__":
    ...
    for test_sequence in (
        # "../datasets/FH_test_walking_day_night/day/1_01_R_20220304201712_avi.avi",
        # "../datasets/FH_test_walking_day_night/night/1_01_A_20220310171644_avi.avi",
        "../datasets/mda_test/test_sequence_motion_1.mp4",
        "../datasets/mda_test/test_sequence_motion_2.mp4",
    ):
